...
namespace IM10
{
    public partial class Form1 : Form
    {
        ...
        {
            TeamParams.Add("Франция", -4.5);
            TeamParams.Add("Италия", -3.7);
            TeamParams.Add("Испания", -3.5);
            TeamParams.Add("Ниггер", -1.3);
            TeamParams.Add("Германия", -5.0);
            TeamParams.Add("Польша", -2.5);
            TeamParams.Add("Великобритания", -3.3);
            TeamParams.Add("Португалия", -3.9);
        }
